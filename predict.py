...
from draw_face import Detection
...
class Detection:
    def __init__(self):
        caffemodel = "weights\Widerface-RetinaFace.caffemodel"
        deploy = "weights\deploy.prototxt"
...
def main():
    ...
    # load image
    img_path = r"train/0/0_000001.jpg"
    ...
    # load model weights
    model_weight_path = "weights/model-11.pth"
    # 加载保存的数据
